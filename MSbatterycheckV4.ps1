...
if ($day -ne "Saturday" -and $day -ne "Sunday" -and $Time24 -ge "09:00" -and $Time24 -le "15:30") {
    ...
    if (Test-Path $logpath){
      ...
      if($global:found -eq $True){ Write-HostLog "Report Details Found"
       ...
       if($global:reportPercentage -lt $Percent){Write-hostlog "Report percentage is $global:reportPercentage which is less than the current $Percent%, quitting script!";WritetoLog}
       Else{
