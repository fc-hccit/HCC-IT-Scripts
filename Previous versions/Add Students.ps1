...
$Workstations = "HCC-DC01,HCC-DC02,ACERL4620-MUS01,ACERL4620-MUS02,ACERL4620-MUS03,ACERL4620-MUS04,ACERL4620-MUS05,ACERL4620-MUS06,ACERL4620-MUS07,ACERL4620-MUS08,ACERL4620-MUS09,ACERL4620-MUS10,ACERL4620-MUS11,ACERL4620-MUS12,ACERL4620-MUS13,ACERL4620-MUS14,ACERL4620-MUS15"
...
$confirm = [System.Windows.Forms.MessageBox]::Show("You are about to add the following students!`n    Year Level  -  Firstname <-> Lastname`n1: Year    $s1y     -  $s1f <-> $s1l`n2: Year    $s2y     -  $s2f <-> $s2l`n3: Year    $s3y     -  $s3f <-> $s3l`n4: Year    $s4y     -  $s4f <-> $s4l`n5: Year    $s5y     -  $s5f <-> $s5l`n", 'Please Confirm', 'YesNo', 'Warning')
...
$Add.Enabled                     = $false
$Add.Add_Click({ if ($Add.Text -eq "Add") {AddStudents} Else {$Form.Close()}}) 



$Form.controls.AddRange(@($S1YR,$S2YR,$S3YR,$S4YR,$S5YR,$S1,$S2,$S3,$S4,$S5,$Label1,$Label2,$Status,$Add))
