...
start "C:\Users\luke.trollope\Documents\Out of warranty log\Out Of Warranty Log.xlsx"
}
...
$Form.text                       = "Out of Warranty Log"
$Form.TopMost                    = $false
$Form.Icon                       = [system.drawing.icon]::ExtractAssociatedIcon("Out Of Warranty.exe")
...
$ComboBox1.add_SelectedIndexChanged({ if($ComboBox1.SelectedIndex -ne "-1") {$Button1.Enabled = $true ; $Button1.text = "Open Excel"}})
