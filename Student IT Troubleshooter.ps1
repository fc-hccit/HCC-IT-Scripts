...
# Email details
$from = "Battery Report <alerts@hopecc.sa.edu.au>"
$to = "itstaff@hopecc.sa.edu.au"
$subject = "Battery report from $username's $devicename"
$smtpServer = "aspmx.l.google.com"

# Send email with the battery report attached
Send-MailMessage -From $from -To $to -Subject $subject -SmtpServer $smtpServer `
-Attachments $reportPath -ErrorAction SilentlyContinue
}
...
$confirm = [System.Windows.Forms.MessageBox]::Show("Is your laptop in airplane mode?", 'Please Confirm', 'YesNo', 'Warning')
...
if ($Network -like '*Hope-Student-WiFi*') {

$ListBox1.items.Add("Student WiFi Available")

$SSID = netsh wlan show interfaces | select-string SSID

if ($SSID -like '*Hope-Student-WiFi*') {

$ListBox1.items.Add("Already Connected To Student WiFi")

Check-Internet

}}}

else{[System.Windows.Forms.MessageBox]::Show("Your computer is not connected to the Student WiFi network. Please connect now!", 'Please Confirm', 'OK', 'Warning')}
...
$listBox1.Items.Clear()
$ListBox1.items.Add("Updating user policy")

Start-Sleep 1

$ListBox1.items.Add("This may take some time...")
...
$ListBox1.items.Add("Is the printer available?")
...
$computerNameLabel.Size = New-Object System.Drawing.Size(400, 20)
...
$adGroupsLabel.Location = New-Object System.Drawing.Point(10, 50)
$adGroupsLabel.Size = New-Object System.Drawing.Size(490, 50)
$adGroupsLabel.Text = "AD Groups:"
$form.Controls.Add($adGroupsLabel)

$deviceOULabel = New-Object System.Windows.Forms.Label
$deviceOULabel.Location = New-Object System.Drawing.Point(10, 100)
$deviceOULabel.Size = New-Object System.Drawing.Size(490, 30)
$deviceOULabel.Text = "Device OU:"
$form.Controls.Add($deviceOULabel)

$serialNumberLabel = New-Object System.Windows.Forms.Label
$serialNumberLabel.Location = New-Object System.Drawing.Point(10, 150)
$serialNumberLabel.Size = New-Object System.Drawing.Size(490, 30)
...
$freeSpaceLabel.Location = New-Object System.Drawing.Point(10, 200)
$freeSpaceLabel.Size = New-Object System.Drawing.Size(400, 30)
...
$output = net user $env:USERNAME /domain
$filteredOutput = $output | Select-String "\*"
$splitOutput = $filteredOutput -split "\*|\s{2,}|`n"
$filteredSplitOutput = $splitOutput[1..($splitOutput.Length - 1)] -ne ""
$adGroups = $filteredSplitOutput -join ", "
$inputString = (Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Group Policy\State\Machine" -Name Distinguished-Name).'Distinguished-Name' 
$splitString = $inputString.Split(',')
$ous = @()
foreach ($item in $splitString) {
if ($item.StartsWith("OU=")) {
$ous += $item.Substring(3)}}
$deviceOU = $ous -join ' / '
$serialNumber = (Get-CimInstance -ClassName Win32_Bios).SerialNumber
$freeSpace = "{0:N2} GB" -f ((Get-PSDrive C).Free / 1GB)
...
$batteryClass = Get-WmiObject -Namespace root\WMI -Class MSBatteryClass -ErrorAction SilentlyContinue
if (!$batteryClass) {$battery_health_percent = "N/A"}
...
$Form                            = New-Object system.Windows.Forms.Form
$Form.ClientSize                 = New-Object System.Drawing.Point(289,420)
...
$Button2.width                   = 175
$Button2.height                  = 35
$Button2.location                = New-Object System.Drawing.Point(54,100)
...
$Button3.width                   = 175
$Button3.height                  = 35
$Button3.location                = New-Object System.Drawing.Point(54,150)
$Button3.Font                    = New-Object System.Drawing.Font('Microsoft Sans Serif',10)
$Button3.Add_Click({sound})

$Button4                         = New-Object system.Windows.Forms.Button
$Button4.text                    = "Printer not available"
$Button4.width                   = 175
$Button4.height                  = 35
$Button4.location                = New-Object System.Drawing.Point(54,200)
$Button4.Font                    = New-Object System.Drawing.Font('Microsoft Sans Serif',10)
$Button4.Add_Click({printing})

$Button5                         = New-Object system.Windows.Forms.Button
$Button5.text                    = "System Info"
$Button5.width                   = 175
$Button5.height                  = 35
$Button5.location                = New-Object System.Drawing.Point(54,250)
$Button5.Font                    = New-Object System.Drawing.Font('Microsoft Sans Serif',10)
$Button5.Add_Click({info})

$ListBox1                        = New-Object system.Windows.Forms.ListBox
$ListBox1.text                   = "listBox"
$ListBox1.width                  = 174
$ListBox1.height                 = 85
$ListBox1.location               = New-Object System.Drawing.Point(54,300)

$Label2                          = New-Object system.Windows.Forms.Label
$Label2.text                     = "Restarted $days days ago   Battery health: $battery_health_percent%"
$Label2.Add_Click({sendreport})
$Label2.AutoSize                 = $true
$Label2.width                    = 25
$Label2.height                   = 10
$Label2.location                 = New-Object System.Drawing.Point(23,390)
$Label2.Font                     = New-Object System.Drawing.Font('Microsoft Sans Serif',10)
if($days -gt 5) {$Label2.ForeColor ="#d0021b"} 
if($battery_health_percent -lt 70) {$Label2.ForeColor ="#d0021b"} 

$Form.controls.AddRange(@($Label1,$Button1,$Button2,$Button3,$Button4,$Button5,$ListBox1,$Label2))`
