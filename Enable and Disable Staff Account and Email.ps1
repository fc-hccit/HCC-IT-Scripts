...
$User = $ComboBox1.SelectedItem
    ...
    $progressbar.Value = 50
    gam update user "$user@hopecc.sa.edu.au" suspended off
...
$users = (Get-ADUser -Filter * -SearchBase "OU=Staff,DC=hopecc,DC=sa,DC=edu,DC=au").SamAccountName
...
$Button2.width                   = 120
$Button2.height                  = 40
$Button2.text                    = "CSV Bulk Staff Disable"
