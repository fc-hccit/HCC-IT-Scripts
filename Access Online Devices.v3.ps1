...
if($CheckBox2.Checked -eq $true ){ Copy-Item $SelectedLocalFile -Destination $Filepath -Force
"$FV $user $computer" | out-file "$LogDir\Filecheck.log" -append -force
}
...
$CheckBox1.width                 = 95
$CheckBox1.height                = 20
$CheckBox1.location              = New-Object System.Drawing.Point(20,615)
...
$CheckBox2.text                  = "Replace File"
$CheckBox2.AutoSize              = $false
$CheckBox2.width                 = 95
$CheckBox2.height                = 20
$CheckBox2.location              = New-Object System.Drawing.Point(120,615)
$CheckBox2.Font                  = New-Object System.Drawing.Font('Microsoft Sans Serif',10)
$CheckBox2.Add_Click({if($CheckBox2.Checked -eq $true ){$Button2.Enabled = $true ; $TextBox1.Enabled = $true ; $Button1.text = "Replace File"} else {$TextBox1.Enabled = $false ; $Button2.Enabled = $false ; $Button1.text = "Search"}})
...
$Button2.width                   = 100
$Button2.height                  = 30
$Button2.location                = New-Object System.Drawing.Point(220,610)
$Button2.Font                    = 'Microsoft Sans Serif,10'
$Button2.Enabled                 = $false
$Button2.Add_Click({
    $openFileDialog = New-Object System.Windows.Forms.OpenFileDialog
    if ($openFileDialog.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) {
        $openFileDialog.FileName = $SelectedLocalFile
    }
})
...
$Button1.width                   = 150
$Button1.height                  = 40
$Button1.location                = New-Object System.Drawing.Point(90,660)
...
$Form.controls.AddRange(@($ListBox1,$ComboBox1,$Button1,$TextBox1,$CheckBox1,$CheckBox2,$Button2,$Label1,$progressBar))
